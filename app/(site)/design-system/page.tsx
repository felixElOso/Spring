...
const typeScale = [
  ...
  { label: 'Body LG · xl', classes: 'text-xl text-foreground/80 leading-relaxed', sample: 'We craft digital experiences that connect brands with people.',                             weight: 400, size: '20px',             usedIn: 'About intro, TextBlock body (md)' },
